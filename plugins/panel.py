...
def get_panel_markup(settings):
    ...
    buttons = [
        [
            InlineKeyboardButton(f"🚀 sʏs: {get_ico('shortener_active')}", callback_data="tg_shortener_active", style="success", icon_custom_emoji_id=5355142851615283756),
            InlineKeyboardButton(f"🌐 ꜰ-ɢᴀᴛᴇ: {get_ico('frontend_verify')}", callback_data="tg_frontend_verify", style="success", icon_custom_emoji_id=5355142851615283756)
        ],
        [
            InlineKeyboardButton(f"🛡️ ʀᴇᴄᴀᴘ: {get_ico('use_recaptcha', False)}", callback_data="set_captcha_recaptcha", style="success", icon_custom_emoji_id=5355142851615283756),
            InlineKeyboardButton(f"🛡️ ᴛᴜʀɴ: {get_ico('use_turnstile', False)}", callback_data="set_captcha_turnstile", style="success", icon_custom_emoji_id=5355142851615283756)
        ],
        [
             InlineKeyboardButton(f"🎲 ʀᴀɴᴅᴏᴍ: {get_ico('random_mode', False)}", callback_data="tg_random_mode", style="success", icon_custom_emoji_id=5355142851615283756),
             InlineKeyboardButton("🔌 ᴀᴘɪ ᴜʀʟ", callback_data="edit_auth_api_url", style="primary", icon_custom_emoji_id=5440389890787281213)
        ],
        [
             InlineKeyboardButton(f"🤝 ʀᴇꜰ: {get_ico('referral_active', True)}", callback_data="tg_referral_active", style="success", icon_custom_emoji_id=5355142851615283756),
             InlineKeyboardButton("🔄 sʏɴᴄ", callback_data="refresh_panel", style="primary", icon_custom_emoji_id=5440389890787281213)
        ],
        [
            InlineKeyboardButton("🆔 ᴀᴘᴘ ɪᴅ", callback_data="edit_auth_app_id", style="primary", icon_custom_emoji_id=5440389890787281213),
            InlineKeyboardButton("🔑 ᴀᴘɪ ʜᴀsʜ", callback_data="edit_auth_api_hash", style="primary", icon_custom_emoji_id=5440389890787281213)
        ],
        [
            InlineKeyboardButton("👑 ᴏᴡɴᴇʀ ɪᴅ", callback_data="edit_auth_owner_id", style="primary", icon_custom_emoji_id=5440389890787281213),
            InlineKeyboardButton("🔑 ᴄᴏʀᴇ ᴄᴏɴꜰɪɢ", callback_data="show_auth", style="primary", icon_custom_emoji_id=5440389890787281213)
        ],
        [
            InlineKeyboardButton("📊 sᴛᴀᴛɪsᴛɪᴄs", callback_data="view_stats", style="primary", icon_custom_emoji_id=5440389890787281213),
            InlineKeyboardButton("🎬 ᴠɪᴅᴇᴏ ᴄᴏɴꜰɪɢ", callback_data="manage_videos", style="primary", icon_custom_emoji_id=5440389890787281213)
        ],
        [
            InlineKeyboardButton("🔗 sʜᴏʀᴛ ᴄᴏɴꜰɪɢ", callback_data="manage_shorteners", style="primary", icon_custom_emoji_id=5440389890787281213),
            InlineKeyboardButton("🤖 ᴄʟᴏɴᴇ ᴍᴀɴᴀɢᴇʀ", callback_data="manage_clones", style="primary", icon_custom_emoji_id=5440389890787281213)
        ],
        [
            InlineKeyboardButton("📝 ᴄᴜsᴛᴏᴍ ᴄᴀᴘᴛɪᴏɴ", callback_data="manage_custom_caption", style="primary", icon_custom_emoji_id=5440389890787281213),
            InlineKeyboardButton("🖼️ ɪᴍᴀɢᴇ ᴄᴏɴꜰɪɢ", callback_data="manage_images", style="primary", icon_custom_emoji_id=5440389890787281213)
        ],
        [
            InlineKeyboardButton("🤖 ʀᴇǫ ʙᴏᴛs", callback_data="view_fsub_bots", style="primary", icon_custom_emoji_id=5440389890787281213),
            InlineKeyboardButton("🤖 ʜᴇʟᴘᴇʀ ʙᴏᴛs", callback_data="manage_helpers", style="primary", icon_custom_emoji_id=5440389890787281213)
        ],
        [
            InlineKeyboardButton("🌐 ᴘʀᴏxɪᴇs", callback_data="manage_proxies", style="primary", icon_custom_emoji_id=5440389890787281213),
            InlineKeyboardButton("📝 ᴠᴇʀɪғʏ ʟᴏɢ", callback_data="manage_verify_log", style="primary", icon_custom_emoji_id=5440389890787281213)
        ],
        [
            InlineKeyboardButton("🛡️ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ sᴇᴛᴛɪɴɢs", callback_data="manage_verification", style="primary", icon_custom_emoji_id=5440389890787281213)
        ],
        [
            InlineKeyboardButton("🔄 ʀᴇsᴛᴀʀᴛ", callback_data="panel_restart", style="danger", icon_custom_emoji_id=5354968347094046619)
        ],
        [
            InlineKeyboardButton("🔄 sʏɴᴄ", callback_data="refresh_panel", style="primary", icon_custom_emoji_id=5440389890787281213),
            InlineKeyboardButton("❌ ᴄʟᴏsᴇ", callback_data="close", style="danger", icon_custom_emoji_id=5354968347094046619)
        ]
    ]
...
async def panel_callback(client: Client, query: CallbackQuery):
    ...
    if data == "delete_session_string":
        ...
        markup = InlineKeyboardMarkup([[InlineKeyboardButton("🔙 ʙᴀᴄᴋ", callback_data="refresh_panel", style="primary", icon_custom_emoji_id=5440389890787281213)]])
        ...
        if not clones:
            ...
            for clone in clones:
                ...
                buttons.append([
                    InlineKeyboardButton(f"⚙️ Configure @{uname}", callback_data=f"conf_clone_{uname}", style="primary", icon_custom_emoji_id=5440389890787281213),
                    InlineKeyboardButton(f"🗑 ᴅᴇʟᴇᴛᴇ", callback_data=f"del_clone_{uname}", style="danger", icon_custom_emoji_id=5354968347094046619)
                ])

        buttons.append([InlineKeyboardButton("➕ ᴀᴅᴅ ɴᴇᴡ ᴄʟᴏɴᴇ", callback_data="add_clone", style="success", icon_custom_emoji_id=5355142851615283756)])
        buttons.append([InlineKeyboardButton("🔙 ʙᴀᴄᴋ", callback_data="refresh_panel", style="primary", icon_custom_emoji_id=5440389890787281213)])
        ...
        buttons = [
            [InlineKeyboardButton("📝 ᴇᴅɪᴛ ɴᴀᴍᴇ", callback_data=f"cset_name_{uname}", style="primary", icon_custom_emoji_id=5440389890787281213), InlineKeyboardButton("🔗 ᴄᴏᴍᴍᴜɴɪᴛʏ ʟɪɴᴋ", callback_data=f"cset_community_link_{uname}", style="primary", icon_custom_emoji_id=5440389890787281213)],
            [InlineKeyboardButton("📢 ꜰsᴜʙ ᴄʜᴀɴɴᴇʟs", callback_data=f"cset_fsub_channels_{uname}", style="primary", icon_custom_emoji_id=5440389890787281213), InlineKeyboardButton("🔑 ᴛᴏᴋᴇɴ", callback_data=f"edit_clone_{uname}", style="primary", icon_custom_emoji_id=5440389890787281213)],
            [InlineKeyboardButton("🔙 ʙᴀᴄᴋ", callback_data="manage_clones", style="primary", icon_custom_emoji_id=5440389890787281213)]
        ]
        return await edit_panel_message(query, text, InlineKeyboardMarkup(buttons))
        ...
        for i, url in enumerate(banners):
            text += f"• `{i+1}`: {url[:30]}...\n"
            buttons.append([InlineKeyboardButton(f"🗑 Delete #{i+1}", callback_data=f"cdel_banner_{uname}_{i}", style="danger", icon_custom_emoji_id=5354968347094046619)])

        buttons.append([InlineKeyboardButton("➕ ᴀᴅᴅ ʙᴀɴɴᴇʀ", callback_data=f"cbanner_add_{uname}", style="success", icon_custom_emoji_id=5355142851615283756)])
        buttons.append([InlineKeyboardButton("🔙 ʙᴀᴄᴋ", callback_data=f"conf_clone_{uname}", style="primary", icon_custom_emoji_id=5440389890787281213)])
        return await edit_panel_message(query, text, InlineKeyboardMarkup(buttons))
        ...
        session_row = [InlineKeyboardButton("🔑 sᴇssɪᴏɴ sᴛʀɪɴɢ", callback_data="edit_auth_session_string", style="primary", icon_custom_emoji_id=5440389890787281213)]
        if settings.get('session_string'):
            session_row.append(InlineKeyboardButton("🗑 ᴅᴇʟᴇᴛᴇ sᴇssɪᴏɴ", callback_data="delete_session_string", style="danger", icon_custom_emoji_id=5354968347094046619))

        buttons = [
            [InlineKeyboardButton("🌐 ᴡᴇʙ ᴜʀʟ", callback_data="edit_auth_website_url", style="primary", icon_custom_emoji_id=5440389890787281213), InlineKeyboardButton("🔌 ᴀᴘɪ ᴜʀʟ", callback_data="edit_auth_api_url", style="primary", icon_custom_emoji_id=5440389890787281213)],
            [InlineKeyboardButton("🌐 ʙᴀsᴇ ᴜʀʟ", callback_data="edit_auth_base_url", style="primary", icon_custom_emoji_id=5440389890787281213), InlineKeyboardButton("🕒 ᴠɪɴᴅᴏᴡ", callback_data="edit_auth_verify_window", style="primary", icon_custom_emoji_id=5440389890787281213)],
            [InlineKeyboardButton("🔢 ᴀᴄᴄᴇss-ʟɪᴍɪᴛ", callback_data="edit_auth_access_limit", style="primary", icon_custom_emoji_id=5440389890787281213), InlineKeyboardButton("🤖 ʙᴏᴛ ɴᴀᴍᴇ", callback_data="edit_auth_bot_name", style="primary", icon_custom_emoji_id=5440389890787281213)],
            [InlineKeyboardButton("🤖 ʙᴏᴛ ᴜsᴇʀɴᴀᴍᴇ", callback_data="edit_auth_bot_username", style="primary", icon_custom_emoji_id=5440389890787281213), InlineKeyboardButton("🔒 ᴘʀᴏᴛᴇᴄᴛ ᴄᴏɴᴛᴇɴᴛ", callback_data="show_shield_settings", style="primary", icon_custom_emoji_id=5440389890787281213)],
            [InlineKeyboardButton("👤 ᴏᴡɴᴇʀ ᴛᴀɢ", callback_data="edit_auth_owner_tag", style="primary", icon_custom_emoji_id=5440389890787281213), InlineKeyboardButton("💸 ᴜᴘɪ ɪᴅ", callback_data="edit_auth_upi_id", style="primary", icon_custom_emoji_id=5440389890787281213)],
            [InlineKeyboardButton("📦 ᴄᴅɴ ᴜʀʟ", callback_data="edit_auth_cdn_url", style="primary", icon_custom_emoji_id=5440389890787281213), InlineKeyboardButton("🛡️ ᴄᴀᴘᴛᴄʜᴀ ᴋᴇʏs", callback_data="show_captcha_keys", style="primary", icon_custom_emoji_id=5440389890787281213)],
            [*session_row],
            [InlineKeyboardButton("🔙 ʙᴀᴄᴋ", callback_data="refresh_panel", style="primary", icon_custom_emoji_id=5440389890787281213)]
        ]
        ...
        buttons = [
            [InlineKeyboardButton("ʀ-sɪᴛᴇ", callback_data="edit_auth_recaptcha_site_key", style="primary", icon_custom_emoji_id=5440389890787281213), InlineKeyboardButton("ʀ-sᴇᴄʀᴇᴛ", callback_data="edit_auth_recaptcha_secret_key", style="primary", icon_custom_emoji_id=5440389890787281213)],
            [InlineKeyboardButton("ᴛ-sɪᴛᴇ", callback_data="edit_auth_turnstile_site_key", style="primary", icon_custom_emoji_id=5440389890787281213), InlineKeyboardButton("ᴛ-sᴇᴄʀᴇᴛ", callback_data="edit_auth_turnstile_secret_key", style="primary", icon_custom_emoji_id=5440389890787281213)],
            [InlineKeyboardButton("🔙 ʙᴀᴄᴋ", callback_data="show_auth", style="primary", icon_custom_emoji_id=5440389890787281213)]
        ]
        return await edit_panel_message(query, text, InlineKeyboardMarkup(buttons))
        ...
        buttons = [
            [
                InlineKeyboardButton(f"Normal: {'🟢' if protect_normal else '🔴'}", callback_data="toggle_protect_protect_content_normal", style="primary", icon_custom_emoji_id=5440389890787281213),
                InlineKeyboardButton(f"Premium: {'🟢' if protect_premium else '🔴'}", callback_data="toggle_protect_protect_content_premium", style="primary", icon_custom_emoji_id=5440389890787281213)
            ],
            [
                InlineKeyboardButton(f"Auth/Admins: {'🟢' if protect_auth else '🔴'}", callback_data="toggle_protect_protect_content_auth", style="primary", icon_custom_emoji_id=5440389890787281213)
            ],
            [
                InlineKeyboardButton("🔙 ʙᴀᴄᴋ", callback_data="show_auth", style="primary", icon_custom_emoji_id=5440389890787281213)
            ]
        ...
        for i, url in enumerate(banners):
            text += f"• `{i+1}`: {url[:30]}...\n"
            buttons.append([InlineKeyboardButton(f"🗑 Delete #{i+1}", callback_data=f"del_banner_{i}", style="danger", icon_custom_emoji_id=5354968347094046619)])

        buttons.append([InlineKeyboardButton("➕ ᴀᴅᴅ ʙᴀɴɴᴇʀ ᴜʀʟ", callback_data="add_banner", style="success", icon_custom_emoji_id=5355142851615283756)])
        buttons.append([InlineKeyboardButton("🔙 ʙᴀᴄᴋ", callback_data="refresh_panel", style="primary", icon_custom_emoji_id=5440389890787281213)])
        return await edit_panel_message(query, text, InlineKeyboardMarkup(buttons))
        ...
        for i in range(len(shorteners)):
            buttons.append([
                InlineKeyboardButton(f"⚙️ sʜᴏʀᴛ {i+1}", callback_data=f"conf_short_{i}", style="primary", icon_custom_emoji_id=5440389890787281213),
                InlineKeyboardButton(f"🗑 ᴅᴇʟᴇᴛᴇ", callback_data=f"del_short_{i}", style="danger", icon_custom_emoji_id=5354968347094046619)
            ])

        buttons.append([InlineKeyboardButton("➕ ᴀᴅᴅ sʜᴏʀᴛᴇɴᴇʀ", callback_data="add_shortener", style="success", icon_custom_emoji_id=5355142851615283756)])
        buttons.append([InlineKeyboardButton("🔙 ʙᴀᴄᴋ", callback_data="refresh_panel", style="primary", icon_custom_emoji_id=5440389890787281213)])
        return await edit_panel_message(query, text, InlineKeyboardMarkup(buttons))
        ...
        if 0 <= idx < len(shorteners):
            ...
            buttons = [
                [
                    InlineKeyboardButton(f"📱 Mini App{get_check('mini_app')}", callback_data=f"set_shmethod_{idx}_mini_app", style="primary", icon_custom_emoji_id=5440389890787281213),
                    InlineKeyboardButton(f"📱 Browser{get_check('browser')}", callback_data=f"set_shmethod_{idx}_browser", style="primary", icon_custom_emoji_id=5440389890787281213)
                ],
                [
                    InlineKeyboardButton(f"🔌 API URL{get_check('api_url')}", callback_data=f"set_shmethod_{idx}_api_url", style="primary", icon_custom_emoji_id=5440389890787281213),
                    InlineKeyboardButton(f"🌐 Web URL{get_check('web_url')}", callback_data=f"set_shmethod_{idx}_web_url", style="primary", icon_custom_emoji_id=5440389890787281213)
                ],
                [
                    InlineKeyboardButton(f"🌐 Own Browser{get_check('own_browser')}", callback_data=f"set_shmethod_{idx}_own_browser", style="primary", icon_custom_emoji_id=5440389890787281213),
                    InlineKeyboardButton(f"🌐 Global Fallback{get_check('global')}", callback_data=f"set_shmethod_{idx}_global", style="primary", icon_custom_emoji_id=5440389890787281213)
                ],
                [
                    InlineKeyboardButton("🔙 ʙᴀᴄᴋ", callback_data="manage_shorteners", style="primary", icon_custom_emoji_id=5440389890787281213)
                ]
            ]
            return await edit_panel_message(query, text, InlineKeyboardMarkup(buttons))
        ...
        for i in range(len(videos)):
            buttons.append([InlineKeyboardButton(f"🗑 ᴅᴇʟᴇᴛᴇ ᴠɪᴅᴇᴏ {i+1}", callback_data=f"del_video_banner_{i}", style="danger", icon_custom_emoji_id=5354968347094046619)])

        buttons.append([InlineKeyboardButton("➕ ᴀᴅᴅ ᴠɪᴅᴇᴏ ᴜʀʟ", callback_data="add_video_banner", style="success", icon_custom_emoji_id=5355142851615283756)])
        buttons.append([InlineKeyboardButton("🔙 ʙᴀᴄᴋ", callback_data="refresh_panel", style="primary", icon_custom_emoji_id=5440389890787281213)])
        return await edit_panel_message(query, text, InlineKeyboardMarkup(buttons))
        ...
        if not helpers:
            ...
            for i, h in enumerate(helpers):
                ...
                buttons.append([InlineKeyboardButton(f"🗑 Delete @{h['username']}", callback_data=f"del_helper_{bot_id}", style="danger", icon_custom_emoji_id=5354968347094046619)])

        buttons.append([InlineKeyboardButton("➕ ᴀᴅᴅ ʜᴇʟᴘᴇʀ ʙᴏᴛ", callback_data="add_helper", style="success", icon_custom_emoji_id=5355142851615283756)])
        buttons.append([InlineKeyboardButton("🔙 ʙᴀᴄᴋ", callback_data="refresh_panel", style="primary", icon_custom_emoji_id=5440389890787281213)])
        return await edit_panel_message(query, text, InlineKeyboardMarkup(buttons))
        ...
        buttons = [
            [
                InlineKeyboardButton("➕ ᴀᴅᴅ ᴘʀᴏxʏ", callback_data="add_proxy_prompt", style="success", icon_custom_emoji_id=5355142851615283756),
                InlineKeyboardButton("🗑 ᴅᴇʟᴇᴛᴇ ᴘʀᴏxʏ", callback_data="delete_proxy_list", style="danger", icon_custom_emoji_id=5354968347094046619)
            ],
            [
                InlineKeyboardButton("🔄 ᴄʜᴇᴄᴋ ᴘʀᴏxɪᴇs", callback_data="check_proxies_act", style="primary", icon_custom_emoji_id=5440389890787281213),
                InlineKeyboardButton(f"⚙️ sᴛʀᴀᴛᴇɢʏ: {proxy_manager.rotation_strategy.replace('_', ' ').upper()}", callback_data="toggle_proxy_strategy", style="primary", icon_custom_emoji_id=5440389890787281213)
            ],
            [
                InlineKeyboardButton("🔙 ʙᴀᴄᴋ", callback_data="refresh_panel", style="primary", icon_custom_emoji_id=5440389890787281213)
            ]
        ...
        for p in proxies:
            masked = mask_proxy(p['proxy'])
            buttons.append([InlineKeyboardButton(f"🗑️ {masked}", callback_data=f"del_proxy_act_{p['id']}", style="danger", icon_custom_emoji_id=5354968347094046619)])

        buttons.append([InlineKeyboardButton("🔙 ʙᴀᴄᴋ", callback_data="manage_proxies", style="primary", icon_custom_emoji_id=5440389890787281213)])
        return await edit_panel_message(query, text, InlineKeyboardMarkup(buttons))
        ...
        buttons = [
            [
                InlineKeyboardButton("➕ sᴇᴛ / ᴇᴅɪᴛ", callback_data="set_caption_prompt", style="primary", icon_custom_emoji_id=5440389890787281213),
                InlineKeyboardButton("🗑 ʀᴇsᴇᴛ / ᴅᴇʟᴇᴛᴇ", callback_data="reset_custom_caption", style="danger", icon_custom_emoji_id=5354968347094046619)
            ],
            [
                InlineKeyboardButton(f"🚀 Tᴏɢɢʟᴇ: {'🟢' if caption_active else '🔴'}", callback_data="toggle_custom_caption", style="success", icon_custom_emoji_id=5355142851615283756)
            ],
            [
                InlineKeyboardButton("🔙 ʙᴀᴄᴋ", callback_data="refresh_panel", style="primary", icon_custom_emoji_id=5440389890787281213)
            ]
        ...
        if not dests:
            ...
            for d in dests:
                ...
                buttons.append([InlineKeyboardButton(f"🗑 Delete {d.get('title')[:20]}", callback_data=f"del_vlog_{d.get('chat_id')}", style="danger", icon_custom_emoji_id=5354968347094046619)])

        if len(dests) < 4:
            buttons.append([InlineKeyboardButton("➕ Add Channel / Group", callback_data="set_verify_log_channel", style="success", icon_custom_emoji_id=5355142851615283756)])

        buttons.append([InlineKeyboardButton("🔙 Back", callback_data="refresh_panel", style="primary", icon_custom_emoji_id=5440389890787281213)])
        return await edit_panel_message(query, text, InlineKeyboardMarkup(buttons))
        ...
        buttons = [
            [
                InlineKeyboardButton(f"🚀 Status: {'🟢 Enabled' if ver_enabled else '🔴 Disabled'}", callback_data="set_ver_toggle", style="success", icon_custom_emoji_id=5355142851615283756)
            ],
            [
                InlineKeyboardButton(f"🔌 API URL{get_check('api_url')}", callback_data="set_ver_method_api_url", style="primary", icon_custom_emoji_id=5440389890787281213),
                InlineKeyboardButton(f"🌐 Web URL{get_check('web_url')}", callback_data="set_ver_method_web_url", style="primary", icon_custom_emoji_id=5440389890787281213)
            ],
            [
                InlineKeyboardButton(f"📱 Mini App{get_check('mini_app')}", callback_data="set_ver_method_mini_app", style="primary", icon_custom_emoji_id=5440389890787281213),
                InlineKeyboardButton(f"📱 Browser{get_check('browser')}", callback_data="set_ver_method_browser", style="primary", icon_custom_emoji_id=5440389890787281213)
            ],
            [
                InlineKeyboardButton(f"🌐 Own Browser{get_check('own_browser')}", callback_data="set_ver_method_own_browser", style="primary", icon_custom_emoji_id=5440389890787281213)
            ]
        ]
        ...
        if ver_method == "own_browser":
            ...
            buttons.append([
                InlineKeyboardButton(f"🌐 With Proxy & Iframe{check_proxy}", callback_data="set_ver_obmode_proxy", style="primary", icon_custom_emoji_id=5440389890787281213),
                InlineKeyboardButton(f"🌐 Normal{check_normal}", callback_data="set_ver_obmode_normal", style="primary", icon_custom_emoji_id=5440389890787281213)
            ])
        elif ver_method == "browser":
            check_proxy = " ✅" if b_mode == "proxy" else ""
            check_normal = " ✅" if b_mode == "normal" else ""
            buttons.append([
                InlineKeyboardButton(f"📱 With Proxy & Iframe{check_proxy}", callback_data="set_ver_bmode_proxy", style="primary", icon_custom_emoji_id=5440389890787281213),
                InlineKeyboardButton(f"📱 Normal{check_normal}", callback_data="set_ver_bmode_normal", style="primary", icon_custom_emoji_id=5440389890787281213)
            ])
